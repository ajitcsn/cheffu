(function () {
  ...
  const stages = [
    ...
    { id: 3, name: "Tadka System", kicker: "Build Indian flavour", icon: "🌶️", colour: "red", description: "Practise tempering, seasoning, dal, rice finishing, and South Indian flavour patterns." },
    { id: 4, name: "One-Pot Engine", kicker: "Let the cooker help", icon: "🫕", colour: "purple", description: "Use ratios and pressure safely to turn grains and legumes into useful meals." },
    { id: 5, name: "Curry Architecture", kicker: "Layer flavour", icon: "🥘", colour: "pink", description: "Combine aromatics, masala, protein, vegetables, and doneness cues into reliable curries." },
    { id: 6, name: "Dough & Fermentation", kicker: "Work with living systems", icon: "🫓", colour: "blue", description: "Build touch, consistency, fermentation judgement, rolling, steaming, and griddle control." },
    { id: 7, name: "Full-Stack Meals", kicker: "Run the whole kitchen", icon: "🏆", colour: "teal", description: "Coordinate components, timing, cleanup, nutrition, and serving as one confident cook." }
  ];
  ...
  const recipes = [
    r("creatine-water", "Creatine + water", 0, "Engineer fuel", "Everywhere", "Vegetarian", 2, 0, 35, "Zero heat", ["setup", "measuring", "mixing", "hygiene"], null, "💧", "Your tutorial mission: find a clean glass, measure once, mix, and reset the counter.", ["Wash and dry your hands.", "Read the product label and use its provided serving measure.", "Add safe drinking water, mix until dispersed, and drink as directed.", "Wash the glass and return the scoop."], "Do not exceed the product label. Supplements are optional, and this app gives no medical advice."),
    ...
    r("protein-shake", "Banana protein shake", 0, "Engineer fuel", "Everywhere", "Vegetarian", 5, 24, 55, "Appliance", ["setup", "measuring", "mixing", "protein", "hygiene"], photos.milk, "🥤", "A first appliance win with milk, banana, and an optional labelled protein powder.", ["Check the mixer jar is clean and unplugged while loading.", "Add milk, banana, and optional powder according to its label.", "Close fully, blend in short pulses, then unplug.", "Pour, rinse the jar immediately, and wash it safely."], "Never put hands or tools in a plugged-in blender jar."),
    ...
    r("moong-khichdi", "Moong dal khichdi", 4, "North Indian", "North India", "Vegan", 30, 15, 130, "One pot", ["rice", "legumes", "pressure", "measuring", "protein", "storage"], photos.khichdi, "🫕", "A forgiving rice-dal system that teaches cooker ratios and a complete meal base.", ["Rinse measured rice and moong dal together.", "Add water, turmeric, salt, and optional vegetables.", "Pressure-cook on controlled heat, then switch off.", "Wait for full natural pressure release, open away, and stir."], "Never force a pressure cooker open. Check its vent, gasket, and fill limit before use."),
    ...
    r("protein-thali", "Engineer protein thali", 7, "Indian everyday", "Pan-Indian", "Vegetarian", 55, 32, 210, "Full meal", ["multitask", "protein", "rice", "legumes", "plating", "storage"], photos.palakPaneer, "🍱", "Coordinate dal, rice or roti, quick sabzi, curd, and salad into one repeatable weekday system.", ["Choose one dal, one grain, one quick vegetable, curd, and raw salad.", "Start the longest item first and write the remaining sequence.", "Use waiting time for cutting, cleanup, and the next component.", "Taste each component, plate by food group, and store leftovers safely."], "Keep raw produce separate from dirty tools and refrigerate perishable leftovers promptly."),
  ...
  const recipeSpecificSkills = {
    "creatine-water": ["weigh-scale", "portion-serving"],
    "lemon-water": ["sieve-strain", "sour-balance"],
    "protein-shake": ["blend-load", "pulse-blend", "weigh-scale", "allergen-check"],
    ...
    "protein-thali": ["batch-plan", "salad-toss", "portion-a-plate", "balanced-plate", "kitchen-reset"],
  ...
  const badges = [
    { id: "first-compile", name: "Baby Steps", icon: "✅", description: "Cook any one dish.", target: 1, type: "cooks" },
    { id: "no-longer-noob", name: "No Longer Noob", icon: "🧢", description: "Complete 3 different dishes.", target: 3, type: "cooks" },
    { id: "protein-compiler", name: "Protein Compiler", icon: "💪", description: "Cook 3 dishes with at least 15 g protein.", target: 3, type: "protein" },
    { id: "heat-tamer", name: "Heat Tamer", icon: "🔥", description: "Practise heat skills in 5 cooks.", target: 5, type: "heat" },
    { id: "south-stack", name: "South Stack", icon: "🌴", description: "Cook 5 South Indian dishes.", target: 5, type: "south" },
    { id: "full-stack-cook", name: "Full-Stack Cook", icon: "🏆", description: "Complete any full meal mission.", target: 1, type: "stage7" }
  ];
